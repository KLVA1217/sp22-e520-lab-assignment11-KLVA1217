...
entity webserver_fw is
  ...
  attribute CORE_GENERATION_INFO of webserver_fw : entity is "webserver_fw,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=webserver_fw,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of webserver_fw : entity is "webserver_fw.hwdef";
end webserver_fw;

architecture STRUCTURE of webserver_fw is
  component webserver_fw_processing_system7_0_0 is
  port (
  ...
  end component webserver_fw_processing_system7_0_0;
...
begin
processing_system7_0: component webserver_fw_processing_system7_0_0
     port map (
